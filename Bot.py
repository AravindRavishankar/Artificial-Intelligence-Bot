	...
	def move(self, temp_board, temp_block, old_move, flag):
		...
		cells  = get_empty_cells(temp_block,temp_board, blocks_allowed,0)
               ...
               ## else:
                ...
                best_cell = findbestcell(temp_board,cells,old_move,ply,temp,temp_block,-10e8,10e8,temp,heuristic_arr1)
...
def assign_heuristic(temp_board,block_no,me):
    ...
    if(h1==1):
        ...
        if(c>=0.09 and c<=0.15):
             if(h1>=0.2  and h1 <=0.3):
        ...
        if(h1-h2<=-0.09 and h1-h2>=-0.15):
            if(h2>=0.2  and h2 <=0.3):
...
def findbestcell(temp_board,cells,old_move,level,player,temp_block,alpha,beta,me,heuristic_arr):
    	...
    	if level == 0:
			...
			save=heuristic_arr[bl_number]
                        ...
                        if  check_won(bl_number,temp_block,x)==1 :
                                if(player==me):
                                    c=cell + (10000,)
                                else:
                                    c=cell+(-10000,)
